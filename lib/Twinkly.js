...
class Twinkly {
    constructor(log, config) {
        ...
        this.requestService = new RequestQueue(log, this.verbose, `http://${ip}/xled/v1`, timeout);
    ...
    setOn(on) {
        ...
        return this.setMode("playlist")
            .then(json => json.code === 1105 ? this.setMode("movie") : json)
            .then(json => json.code === 1104 ? this.setMode("effect") : json);
    }
